...
namespace Net.Code.ADONet.Tests.Unit.Extensions.Experimental
{
	...
	public class FastReflectionTests
	{
		...
		public void SetterGetterSpeedTest()
		{
			...
			// via a backing field under the hood.  As a result, the new 
		...
		public void FieldPropertyAccessTest()
		{
			...
			setters["Field0"](instance, 1);
			setters["Field1"](instance, 2);
			setters["Prop0"](instance, 3);
			setters["Prop1"](instance, 4);

			Assert.IsTrue(1.Equals(getters["Field0"](instance)));
			Assert.IsTrue(2.Equals(getters["Field1"](instance)));
			Assert.IsTrue(3.Equals(getters["Prop0"](instance)));
			Assert.IsTrue(4.Equals(getters["Prop1"](instance)));
		}
